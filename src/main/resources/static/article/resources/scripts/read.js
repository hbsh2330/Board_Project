...
//                 ${typeof targetComment['content'] === 'string' ? '' : 'deleted'}" data-index="${targetComment['index']}" rel="comment">
//             <div class="head">
...
//             </div>
//             <div class="body">${typeof targetComment['content'] === 'string' ? ${targetComment['content'] : '삭제된 댓글입니다.'}</div>
//             <div class="foot">
...
//                                     dialog.show({
//                                         title: '오류',
//                                         content: '알수없는 이유로 댓글을 삭제하지 못하였습니다.',
//                                         buttons: [dialog.createButton('확인', dialog.hide)]
//                                     })
//                                     break
//                                 case 'success':
